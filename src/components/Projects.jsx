...
const Projects = () => {
  const projects = [
  {
    ...
    description:
      "Full-stack AI-powered research companion that summarizes papers, generates abstracts, creates slides, and answers research queries in real-time.",
    tech: [
      "MERN Stack",
      "Google Gemini API",
      "Node.js",
    ...
    features: [
      ...
      "AI Abstract & Slide Generator",
      "Knowledge Graphs + Citation Extractor",
      "Collaborative Notes & Co-Research",
    ],
    color: "neon-pink",
  ...
  },
  {
    ...
    description:
      "Responsive personal portfolio showcasing projects, achievements, and skills — optimized for SEO and fast load times.",
    tech: ["React", "Tailwind CSS", "Framer Motion", "GitHub Pages"],
    features: [
      "Dark/Light Mode",
      "Responsive Design",
      "40% Faster Page Loads",
      "SEO Optimization & Custom Animations",
    ],
    color: "neon-blue",
  ...
  },
  {
    ...
    description:
      "Geolocation-based app to find nearby stations, restaurants, hotels, and attractions with Google Maps integration.",
    tech: ["React", "Google Maps API", "Geolocation API", "Tailwind CSS"],
    features: [
